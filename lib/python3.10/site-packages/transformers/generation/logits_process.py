...
class MinNewTokensLengthLogitsProcessor(LogitsProcessor):
    ...
    ```python
    >>> from llm_module import AutoTokenizer, AutoModelForCausalLM
...
class TemperatureLogitsWarper(LogitsWarper):
    ...
    ```python
    >>> import torch
    >>> from llm_module import AutoTokenizer, AutoModelForCausalLM, set_seed
...
class HammingDiversityLogitsProcessor(LogitsProcessor):
    ...
    ```python
    >>> from llm_module import AutoTokenizer, AutoModelForSeq2SeqLM
    >>> import torch
