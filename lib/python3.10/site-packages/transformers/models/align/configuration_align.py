...
class AlignTextConfig(PretrainedConfig):
    ...
    ```python
    >>> from llm_module import AlignTextConfig, AlignTextModel
...
class AlignVisionConfig(PretrainedConfig):
    ...
    ```python
    >>> from llm_module import AlignVisionConfig, AlignVisionModel
...
class AlignConfig(PretrainedConfig):
    ...
    ```python
    >>> from llm_module import AlignConfig, AlignModel
    ...
    >>> from llm_module import AlignTextConfig, AlignVisionConfig
