...
from llm_module.modeling_utils import dtype_byte_size
from llm_module.models.switch_transformers.convert_switch_transformers_original_flax_checkpoint_to_pytorch import (
    rename_keys,
)
from llm_module.utils import WEIGHTS_INDEX_NAME, WEIGHTS_NAME
from llm_module.utils.hub import convert_file_size_to_int
...
def sanity_check():
    from llm_module import SwitchTransformersConfig, SwitchTransformersForConditionalGeneration, T5Tokenizer
