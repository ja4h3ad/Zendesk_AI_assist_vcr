...
class Wav2Vec2ConformerForPreTraining(Wav2Vec2ConformerPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> import torch
        >>> from llm_module import AutoFeatureExtractor, Wav2Vec2ConformerForPreTraining
        >>> from llm_module.models.wav2vec2_conformer.modeling_wav2vec2_conformer import (
