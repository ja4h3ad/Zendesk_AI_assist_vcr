...
class UniSpeechSatForPreTraining(UniSpeechSatPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> import torch
        >>> from llm_module import AutoFeatureExtractor, UniSpeechSatForPreTraining
        >>> from llm_module.models.unispeech_sat.modeling_unispeech_sat import _compute_mask_indices
