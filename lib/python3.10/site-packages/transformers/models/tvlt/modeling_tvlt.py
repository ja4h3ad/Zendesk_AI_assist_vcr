...
class TvltModel(TvltPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from llm_module import TvltProcessor, TvltModel
        >>> import numpy as np
        >>> import torch
...
class TvltForPreTraining(TvltPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from llm_module import TvltProcessor, TvltForPreTraining
        >>> import numpy as np
        >>> import torch
...
class TvltForAudioVisualClassification(TvltPreTrainedModel):
    ...
    def forward(
        ...
        Examples:
        ```python
        >>> from llm_module import TvltProcessor, TvltForAudioVisualClassification
        >>> import numpy as np
        >>> import torch
