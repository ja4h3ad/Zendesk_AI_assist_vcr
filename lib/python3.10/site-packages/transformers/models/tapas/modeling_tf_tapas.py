...
class TFTapasModel(TFTapasPreTrainedModel):
    ...
    def call(
        ...
        ```python
        >>> from llm_module import AutoTokenizer, TapasModel
        >>> import pandas as pd
...
class TFTapasForMaskedLM(TFTapasPreTrainedModel, TFMaskedLanguageModelingLoss):
    ...
    def call(
        ...
        ```python
        >>> from llm_module import AutoTokenizer, TapasForMaskedLM
        >>> import pandas as pd
...
class TFTapasForQuestionAnswering(TFTapasPreTrainedModel):
    ...
    def call(
        ...
        ```python
        >>> from llm_module import AutoTokenizer, TapasForQuestionAnswering
        >>> import pandas as pd
...
class TFTapasForSequenceClassification(TFTapasPreTrainedModel, TFSequenceClassificationLoss):
    ...
    def call(
        ...
        ```python
        >>> from llm_module import AutoTokenizer, TapasForSequenceClassification
        >>> import tensorflow as tf
        >>> import pandas as pd
