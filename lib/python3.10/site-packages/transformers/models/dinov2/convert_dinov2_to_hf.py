...
from llm_module import BitImageProcessor, Dinov2Config, Dinov2Model
from llm_module.image_utils import IMAGENET_DEFAULT_MEAN, IMAGENET_DEFAULT_STD, PILImageResampling
