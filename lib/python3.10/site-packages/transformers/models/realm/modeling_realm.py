...
class RealmEmbedder(RealmPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from llm_module import AutoTokenizer, RealmEmbedder
        >>> import torch
...
class RealmScorer(RealmPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> import torch
        >>> from llm_module import AutoTokenizer, RealmScorer
...
class RealmKnowledgeAugEncoder(RealmPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> import torch
        >>> from llm_module import AutoTokenizer, RealmKnowledgeAugEncoder
...
class RealmForOpenQA(RealmPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> import torch
        >>> from llm_module import RealmForOpenQA, RealmRetriever, AutoTokenizer
