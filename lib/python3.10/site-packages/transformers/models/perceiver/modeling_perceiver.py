...
class PerceiverModel(PerceiverPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from llm_module import PerceiverConfig, PerceiverTokenizer, PerceiverImageProcessor, PerceiverModel
        >>> from llm_module.models.perceiver.modeling_perceiver import (
...
class PerceiverForMaskedLM(PerceiverPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from llm_module import AutoTokenizer, PerceiverForMaskedLM
        >>> import torch
...
class PerceiverForSequenceClassification(PerceiverPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from llm_module import AutoTokenizer, PerceiverForSequenceClassification
...
class PerceiverForImageClassificationLearned(PerceiverPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from llm_module import AutoImageProcessor, PerceiverForImageClassificationLearned
        >>> from PIL import Image
        >>> import requests
...
class PerceiverForImageClassificationFourier(PerceiverPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from llm_module import AutoImageProcessor, PerceiverForImageClassificationFourier
        >>> from PIL import Image
        >>> import requests
...
class PerceiverForImageClassificationConvProcessing(PerceiverPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from llm_module import AutoImageProcessor, PerceiverForImageClassificationConvProcessing
        >>> from PIL import Image
        >>> import requests
...
class PerceiverForOpticalFlow(PerceiverPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from llm_module import PerceiverForOpticalFlow
        >>> import torch
...
class PerceiverForMultimodalAutoencoding(PerceiverPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from llm_module import PerceiverForMultimodalAutoencoding
        >>> import torch
        >>> import numpy as np
