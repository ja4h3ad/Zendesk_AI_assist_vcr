...
class RoCBertForPreTraining(RoCBertPreTrainedModel):
    ...
    def forward(
        ...
        **kwargs,
        ...
        ```python
        >>> from llm_module import AutoTokenizer, RoCBertForPreTraining
        >>> import torch
...
class RoCBertForMaskedLM(RoCBertPreTrainedModel):
    ...
    def forward(
        ...
        Example:
        ```python
        >>> from llm_module import AutoTokenizer, RoCBertForMaskedLM
        >>> import torch
...
class RoCBertForCausalLM(RoCBertPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from llm_module import AutoTokenizer, RoCBertForCausalLM, RoCBertConfig
        >>> import torch
