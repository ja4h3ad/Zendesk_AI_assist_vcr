...
class MarkupLMModel(MarkupLMPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from llm_module import AutoProcessor, MarkupLMModel
...
class MarkupLMForQuestionAnswering(MarkupLMPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from llm_module import AutoProcessor, MarkupLMForQuestionAnswering
        >>> import torch
...
class MarkupLMForTokenClassification(MarkupLMPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from llm_module import AutoProcessor, AutoModelForTokenClassification
        >>> import torch
...
class MarkupLMForSequenceClassification(MarkupLMPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from llm_module import AutoProcessor, AutoModelForSequenceClassification
        >>> import torch
