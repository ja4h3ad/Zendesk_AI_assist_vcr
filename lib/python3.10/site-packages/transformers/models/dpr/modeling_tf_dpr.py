...
class TFDPRContextEncoder(TFDPRPretrainedContextEncoder):
    ...
    def call(
        ...
        ```python
        >>> from llm_module import TFDPRContextEncoder, DPRContextEncoderTokenizer
...
class TFDPRQuestionEncoder(TFDPRPretrainedQuestionEncoder):
    ...
    def call(
        ...
        ```python
        >>> from llm_module import TFDPRQuestionEncoder, DPRQuestionEncoderTokenizer
...
class TFDPRReader(TFDPRPretrainedReader):
    ...
    def call(
        ...
        ```python
        >>> from llm_module import TFDPRReader, DPRReaderTokenizer
