...
class VideoMAEModel(VideoMAEPreTrainedModel):
    ...
    def forward(
        ...
        >>> from llm_module import AutoImageProcessor, VideoMAEModel
...
class VideoMAEForPreTraining(VideoMAEPreTrainedModel):
    ...
    def forward(
        ...
        Examples:
        ```python
        >>> from llm_module import AutoImageProcessor, VideoMAEForPreTraining
        >>> import numpy as np
        >>> import torch
...
class VideoMAEForVideoClassification(VideoMAEPreTrainedModel):
    ...
    def forward(
        ...
        >>> from llm_module import AutoImageProcessor, VideoMAEForVideoClassification
        >>> from huggingface_hub import hf_hub_download
