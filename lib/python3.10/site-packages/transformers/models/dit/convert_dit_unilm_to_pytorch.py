...
from llm_module import BeitConfig, BeitForImageClassification, BeitForMaskedImageModeling, BeitImageProcessor
from llm_module.image_utils import PILImageResampling
