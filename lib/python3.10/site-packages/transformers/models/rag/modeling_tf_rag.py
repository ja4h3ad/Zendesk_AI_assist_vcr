...
class TFRagPreTrainedModel(TFPreTrainedModel):
    ...
    def from_pretrained_question_encoder_generator(
        ...
        **kwargs,
        ...
        ```python
        >>> from llm_module import RagRetriever, TFRagModel
...
class TFRagModel(TFRagPreTrainedModel):
    ...
    def call(
        ...
        **kwargs,
        ...
        ```python
        >>> from llm_module import AutoTokenizer, RagRetriever, TFRagModel
        >>> import torch
...
class TFRagTokenForGeneration(TFRagPreTrainedModel, TFCausalLanguageModelingLoss):
    ...
    def call(
        ...
        **kwargs,  # needs kwargs for generation
        ...
        ```python
        >>> import tensorflow as tf
        >>> from llm_module import AutoTokenizer, RagRetriever, TFRagTokenForGeneration
...
class TFRagSequenceForGeneration(TFRagPreTrainedModel, TFCausalLanguageModelingLoss):
    ...
    def call(
        ...
        **kwargs,  # needs kwargs for generation
        ...
        ```python
        >>> from llm_module import AutoTokenizer, RagRetriever, TFRagSequenceForGeneration
