...
class TFVisionEncoderDecoderModel(TFPreTrainedModel, TFCausalLanguageModelingLoss):
    ...
    def from_pretrained(cls, pretrained_model_name_or_path, *model_args, **kwargs):
        ...
        ```python
        >>> from llm_module import TFVisionEncoderDecoderModel, AutoImageProcessor, AutoTokenizer
    ...
    def call(
        ...
        **kwargs,
        ...
        ```python
        >>> from llm_module import AutoImageProcessor, AutoTokenizer, TFVisionEncoderDecoderModel
        >>> from PIL import Image
        >>> import requests
