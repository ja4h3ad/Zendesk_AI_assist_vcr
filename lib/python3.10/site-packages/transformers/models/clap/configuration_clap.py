...
class ClapTextConfig(PretrainedConfig):
    ...
    ```python
    >>> from llm_module import ClapTextConfig, ClapTextModel
...
class ClapAudioConfig(PretrainedConfig):
    ...
    ```python
    >>> from llm_module import ClapAudioConfig, ClapAudioModel
...
class ClapConfig(PretrainedConfig):
    ...
    ```python
    >>> from llm_module import ClapConfig, ClapModel
    ...
    >>> from llm_module import ClapTextConfig, ClapAudioConfig
