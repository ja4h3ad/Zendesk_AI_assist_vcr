...
class ClapAudioModel(ClapPreTrainedModel):
    ...
    def forward(
        ...
        >>> from llm_module import AutoProcessor, ClapAudioModel
...
class ClapModel(ClapPreTrainedModel):
    ...
    def get_text_features(
        ...
        ```python
        >>> from llm_module import AutoTokenizer, ClapModel
    ...
    def get_audio_features(
        ...
        ```python
        >>> from llm_module import AutoFeatureExtractor, ClapModel
        >>> import torch
    ...
    def forward(
        ...
        ```python
        >>> from datasets import load_dataset
        >>> from llm_module import AutoProcessor, ClapModel
...
class ClapTextModelWithProjection(ClapPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from llm_module import AutoTokenizer, ClapTextModelWithProjection
...
class ClapAudioModelWithProjection(ClapPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from datasets import load_dataset
        >>> from llm_module import ClapAudioModelWithProjection, ClapProcessor
