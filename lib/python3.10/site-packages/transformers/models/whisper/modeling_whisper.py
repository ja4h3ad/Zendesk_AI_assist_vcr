...
class WhisperModel(WhisperPreTrainedModel):
    ...
    def forward(
        ...
        Example:
         ```python
         >>> import torch
         >>> from llm_module import AutoFeatureExtractor, WhisperModel
...
class WhisperForConditionalGeneration(WhisperPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> import torch
        >>> from llm_module import AutoProcessor, WhisperForConditionalGeneration
        >>> from datasets import load_dataset
...
class WhisperForAudioClassification(WhisperPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> import torch
        >>> from llm_module import AutoFeatureExtractor, WhisperForAudioClassification
        >>> from datasets import load_dataset
