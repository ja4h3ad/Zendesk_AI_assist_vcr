...
class ViltModel(ViltPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from llm_module import ViltProcessor, ViltModel
...
class ViltForMaskedLM(ViltPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from llm_module import ViltProcessor, ViltForMaskedLM
        >>> import requests
        >>> from PIL import Image
        >>> import re
        >>> import torch
...
class ViltForQuestionAnswering(ViltPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from llm_module import ViltProcessor, ViltForQuestionAnswering
        >>> import requests
        >>> from PIL import Image
...
class ViltForImageAndTextRetrieval(ViltPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from llm_module import ViltProcessor, ViltForImageAndTextRetrieval
        >>> import requests
        >>> from PIL import Image
...
class ViltForImagesAndTextClassification(ViltPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from llm_module import ViltProcessor, ViltForImagesAndTextClassification
        >>> import requests
        >>> from PIL import Image
