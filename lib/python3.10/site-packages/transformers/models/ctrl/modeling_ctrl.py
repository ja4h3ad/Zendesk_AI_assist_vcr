...
class CTRLModel(CTRLPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from llm_module import AutoTokenizer, CTRLModel
        >>> import torch
...
class CTRLLMHeadModel(CTRLPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> import torch
        >>> from llm_module import AutoTokenizer, CTRLLMHeadModel
...
class CTRLForSequenceClassification(CTRLPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> import torch
        >>> from llm_module import AutoTokenizer, CTRLForSequenceClassification
