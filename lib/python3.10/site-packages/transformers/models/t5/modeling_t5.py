...
class T5Model(T5PreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from llm_module import AutoTokenizer, T5Model
...
class T5ForConditionalGeneration(T5PreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from llm_module import AutoTokenizer, T5ForConditionalGeneration
...
class T5EncoderModel(T5PreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from llm_module import AutoTokenizer, T5EncoderModel
