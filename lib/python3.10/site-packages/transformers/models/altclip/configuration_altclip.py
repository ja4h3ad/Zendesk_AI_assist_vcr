...
class AltCLIPTextConfig(PretrainedConfig):
    ...
    ```python
    >>> from llm_module import AltCLIPTextModel, AltCLIPTextConfig
...
class AltCLIPVisionConfig(PretrainedConfig):
    ...
    ```python
    >>> from llm_module import AltCLIPVisionConfig, AltCLIPVisionModel
...
class AltCLIPConfig(PretrainedConfig):
    ...
    ```python
    >>> from llm_module import AltCLIPConfig, AltCLIPModel
