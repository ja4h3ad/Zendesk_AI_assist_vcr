...
class CLIPSegTextConfig(PretrainedConfig):
    ...
    ```python
    >>> from llm_module import CLIPSegTextConfig, CLIPSegTextModel
...
class CLIPSegVisionConfig(PretrainedConfig):
    ...
    ```python
    >>> from llm_module import CLIPSegVisionConfig, CLIPSegVisionModel
...
class CLIPSegConfig(PretrainedConfig):
    ...
    ```python
    >>> from llm_module import CLIPSegConfig, CLIPSegModel
