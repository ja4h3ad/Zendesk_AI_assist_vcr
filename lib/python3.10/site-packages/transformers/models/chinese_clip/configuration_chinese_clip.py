...
class ChineseCLIPTextConfig(PretrainedConfig):
    ...
    ```python
    >>> from llm_module import ChineseCLIPTextConfig, ChineseCLIPTextModel
...
class ChineseCLIPVisionConfig(PretrainedConfig):
    ...
    Example:
    ```python
    >>> from llm_module import ChineseCLIPVisionConfig, ChineseCLIPVisionModel
...
class ChineseCLIPConfig(PretrainedConfig):
    ...
    ```python
    >>> from llm_module import ChineseCLIPConfig, ChineseCLIPModel
