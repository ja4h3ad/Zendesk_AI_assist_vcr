...
class FlavaImageConfig(PretrainedConfig):
    ...
    ```python
    >>> from llm_module import FlavaImageConfig, FlavaImageModel
...
class FlavaTextConfig(PretrainedConfig):
    ...
    ```python
    >>> from llm_module import FlavaTextConfig, FlavaTextModel
...
class FlavaMultimodalConfig(PretrainedConfig):
    ...
    ```python
    >>> from llm_module import FlavaMultimodalConfig, FlavaMultimodalModel
...
class FlavaConfig(PretrainedConfig):
    ...
    ```python
    >>> from llm_module import FlavaConfig, FlavaModel, FlavaForPreTraining
