...
class TFMT5Model(TFT5Model):
    ...
    ```python
    >>> from llm_module import TFMT5Model, AutoTokenizer
...
class TFMT5ForConditionalGeneration(TFT5ForConditionalGeneration):
    ...
    ```python
    >>> from llm_module import TFMT5ForConditionalGeneration, AutoTokenizer
...
class TFMT5EncoderModel(TFT5EncoderModel):
    ...
    ```python
    >>> from llm_module import TFMT5EncoderModel, AutoTokenizer
