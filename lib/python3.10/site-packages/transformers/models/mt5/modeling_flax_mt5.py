...
class FlaxMT5Model(FlaxT5Model):
    ...
    ```python
    >>> from llm_module import FlaxMT5Model, AutoTokenizer
...
class FlaxMT5EncoderModel(FlaxT5EncoderModel):
    ...
    ```python
    >>> from llm_module import FlaxT5EncoderModel, AutoTokenizer
...
class FlaxMT5ForConditionalGeneration(FlaxT5ForConditionalGeneration):
    ...
    ```python
    >>> from llm_module import FlaxMT5ForConditionalGeneration, AutoTokenizer
