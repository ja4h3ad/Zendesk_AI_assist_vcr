...
class MT5Model(MT5PreTrainedModel):
    ...
    ```python
    >>> from llm_module import MT5Model, AutoTokenizer
    ...
    def forward(
        ...
        ```python
        >>> from llm_module import AutoTokenizer, MT5Model
...
class MT5ForConditionalGeneration(MT5PreTrainedModel):
    ...
    ```python
    >>> from llm_module import MT5ForConditionalGeneration, AutoTokenizer
    ...
    def forward(
        ...
        ```python
        >>> from llm_module import AutoTokenizer, MT5ForConditionalGeneration
...
class MT5EncoderModel(MT5PreTrainedModel):
    ...
    ```python
    >>> from llm_module import MT5EncoderModel, AutoTokenizer
    ...
    def forward(
        ...
        ```python
        >>> from llm_module import AutoTokenizer, MT5EncoderModel
